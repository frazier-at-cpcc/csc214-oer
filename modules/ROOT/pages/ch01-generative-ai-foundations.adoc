...
In Lab 01, you will navigate the Microsoft Foundry model catalog and deploy a language model. As you work through the lab, pay attention to the following:
