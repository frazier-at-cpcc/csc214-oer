...
image::ch03/g3-1-agent-execution-loop.png[Agent Execution Loop]
...
image::ch03/g3-2-agent-vs-chat-comparison.png[Agent vs. Chat Completion Comparison]
...
image::ch03/g3-3-agent-vs-chat-decision.png[Agent vs. Chat Completion Decision Flowchart]
...
image::ch03/g3-4-tool-definition-anatomy.png[Tool Definition Anatomy]
...
image::ch03/g3-5-tool-call-lifecycle.png[Tool Call Lifecycle]
