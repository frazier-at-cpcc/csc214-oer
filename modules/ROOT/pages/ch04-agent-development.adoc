...
image::ch04/g4-1-mcp-client-server.png[MCP Client-Server Architecture]
...
image::ch04/g4-2-mcp-connection-lifecycle.png[MCP Connection Lifecycle]
...
image::ch04/g4-3-foundry-iq-agentic-retrieval.png[Foundry IQ Agentic Retrieval]
