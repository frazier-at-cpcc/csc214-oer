...
image::ch06/g6-2-text-analysis-agent.png[Text-Analysis Agent]
...
image::ch06/g6-4-voice-live-agent-loop.png[Voice Live Agent Loop]
...
image::ch06/g6-5-generative-text-pipeline.png[Generative Text Pipeline for Law Firm]
