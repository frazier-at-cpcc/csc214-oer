...
// GRAPHIC TODO: image-generation-and-editing
image::ch07/g7-8-image-generation-editing.png[Image Generation and Editing]
...
// GRAPHIC TODO: content-understanding-image-pipeline
image::ch07/g7-9-content-understanding-image.png[Content Understanding for Images]
...
// GRAPHIC TODO: indirect-prompt-injection-in-images
image::ch07/g7-10-indirect-prompt-injection.png[Indirect Prompt Injection in Images]
...
// GRAPHIC TODO: vision-capability-matrix-ai103
...
// GRAPHIC TODO: vision-service-selection-ai103
...
**Lab 18: Develop a vision-enabled chat app.** You will build a chat application that accepts both text and images and sends them to a multimodal model through Azure AI Foundry, then use it to caption images, answer grounded visual questions, and generate accessibility descriptions. This lab brings Section 7.2 to life. Watch for:
