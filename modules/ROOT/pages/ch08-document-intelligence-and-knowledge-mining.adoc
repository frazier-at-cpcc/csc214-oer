...
image::ch08/g8-1-content-understanding-extraction.png[Content Understanding Multimodal Extraction]
...
image::ch08/g8-2-solution-architecture-template.png[Agentic Multimodal Solution Architecture Template]
...
image::ch08/g8-3-design-justification-structure.png[Design Justification Structure]
