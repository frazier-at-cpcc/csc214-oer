...
| Content Understanding extraction pipelines, multimodal RAG combining documents and images, Azure AI Search knowledge mining, and the capstone design project integrating services from across the course.
